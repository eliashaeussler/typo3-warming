...
export class WarmupProgress {
  ...
  public getFailedUrls(): CrawlingResult[] {
    ...
    return this.urls.failed.map(WarmupProgress.mapUrlToCrawlingResult);
  }
  ...
  public getSuccessfulUrls(): CrawlingResult[] {
    ...
    return this.urls.successful.map(WarmupProgress.mapUrlToCrawlingResult);
  }
   ...
   * @private
   */
  private static mapUrlToCrawlingResult(url: string): CrawlingResult {
    return {
      url: url,
      data: {},
    };

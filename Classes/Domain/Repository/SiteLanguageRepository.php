 ...
 */
final class SiteLanguageRepository
{
    ...
    public function findAll(
        ...
        $siteLanguages = $backendUser !== null ? $site->getAvailableLanguages($backendUser) : $site->getLanguages();
    ...
    {
        return !$this->isExcluded($siteLanguage)
            && Utility\AccessUtility::canWarmupCacheOfSite($site, $siteLanguage->getLanguageId());
    }
